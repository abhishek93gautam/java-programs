...
public class BuildOrder {
	 ...
	 * before b. */
	public static GraphBuildOrder buildGraph(String[] projects, String[][] dependencies) {
		GraphBuildOrder graph = new GraphBuildOrder();
	...
	public static Project[] findBuildOrder(String[] projects, String[][] dependencies) {
		GraphBuildOrder graph = buildGraph(projects, dependencies);
