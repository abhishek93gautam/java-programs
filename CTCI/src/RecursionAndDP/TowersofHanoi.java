...
public class TowersofHanoi {
	...
	public static void main(String[] args) {
		...
		towers[0].print();
		towers[0].moveDisks_Old(n, towers[2], towers[1]);
		towers[2].print();
...
class Tower
{
	...
	public void moveDisks_Old(int n,Tower destination,Tower buffer)
	{
		if(n>0)
		{
			moveDisks_Old(n-1,buffer,destination);
			moveTopTo(destination);
			buffer.moveDisks_Old(n-1, destination, this);
		}
	}
